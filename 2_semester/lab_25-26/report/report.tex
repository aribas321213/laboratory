...
\begin{document}
    ...
    \begin{spacing}{1.7}
        \hspace{1.2in}
        \textbf {Отчет по Лабораторной работе} № 25-26\\     % указать номер лабораторной
        ...
        \indent \hspace{1.2in} Работа выполнена: "21 мая 2022г" \\   % указать дату
    ...
    \begin{spacing}{1}
        \indent \textbf{1. Тема}: \underline{Абстрактные типы данных. Рекурсия.Модульное программирование на языке Си.}\\               % Ввести тему
        \indent \textbf{2. Цель работы}: \underline{Автоматизация сборки программ модульной структуры на языке Си с}\\
        \indent \underline{Процедура: поиск и удаление максимального элемента.} \\   % Ввести цель работы      % Ввести цель работы   
        \indent \textbf{3. Задание}: \underline{АТД: Стек, Метод: сортировка линейным выбором, Процедура: поиск и }\\
        \indent \underline{удаление максимального элемента.}\\% Ввести задание
    ...
    \begin{spacing}{1}
        ...
        \indent \textbf{11.} Выводы \underline{\hspace{0.1in}Я научился автоматизировать сборку программ модульной структуры}\\
        \underline{на языке Си с использованием утилиты make.\hspace{0.2in}}\\
