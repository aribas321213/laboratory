...
\begin{document}
    ...
    \begin{spacing}{1.7}
        \hspace{1.2in}
        \textbf {Отчет по Курсовой работе} № 8\\     % указать номер лабораторной
    ...
    \begin{spacing}{1}
        \indent \textbf{1. Тема}: \underline{Линейныйе списки.}\\               % Ввести тему
        \indent \textbf{2. Цель работы}: \underline{Составить и отладить программу на языке Си обработки линейного списка } \\
        \indent \underline{заданной организации с отображением списка на динамические структуры.} \\   % Ввести цель работы      % Ввести цель работы   
        ...
        \indent \underline{Если в списке менее k элементов, то не менять его}\\  % Ввести задание
