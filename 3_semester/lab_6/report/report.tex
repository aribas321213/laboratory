...
\begin{document}
    \begin{titlepage}
        \begin{center}
            ...
            \vspace{0.4in}
            \textbf{\LARGE{Лабораторная работa 6 по курсу ОOП:}}\\
    ...
    \begin{center}
        \includegraphics[scale=0.5]{formal/lab_6.png}\\
    \end{center}

    
    \textbf{Вывод}\\
    При ассоциации взаимодействующие объекты, между собой условно находятся на одном уровне. 
    Ни один из объектов не имеет превосходства над другим, и из любого можно получить другой, 
