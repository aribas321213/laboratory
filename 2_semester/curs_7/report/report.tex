...
\begin{document}
    ...
    \begin{spacing}{1.7}
        \hspace{1.2in}
        \textbf {Отчет по Курсовой работе} № 7\\     % указать номер лабораторной
        ...
        \indent \hspace{1.2in} Работа выполнена: "17 апреля 2022г" \\   % указать дату
    ...
    \begin{spacing}{1}
        \indent \textbf{1. Тема}: \underline{Разреженные матрицы.}\\               % Ввести тему
        \indent \textbf{2. Цель работы}: \underline{Составить программу на языке Си с процедурами и/или функциями для } \\
        \indent \underline{обработки прямоугольных разреженных матриц с элементами целого, вещественного,} \\ 
        \indent \underline{или комплексного типов.} \\       % Ввести цель работы      % Ввести цель работы
        \indent \textbf{3. Задание}: \underline{Вариант схемы размещения матрицы: 3. Три вектора;}\\
        \indent \underline{Вариант преобразований: Определить максимальный по модулю элемент матрицы и разделить}\\
        \indent \underline{на него все элементы строки, в которой он находится. Если таких элементов несколько, обработать}\\
        \indent \underline{каждую строку, содержащую такой элемент. }  \\           % Ввести задание
    ...
    \begin{spacing}{1}
        ...
        \indent \textbf{11.} Выводы \underline{\hspace{0.5in}Я научился работать с разреженными матрицами.\hspace{0.5in}}\\
