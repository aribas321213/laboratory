...
\begin{document}
    ...
    \begin{spacing}{1.7}
        \hspace{1.2in}
        \textbf {Отчет по Курсовой работе} № 6\\     % указать номер лабораторной
        ...
        \indent \hspace{1.2in} Работа выполнена: "31 марта 2022г" \\   % указать дату
