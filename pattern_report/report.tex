...
\begin{document}
    ...
    \begin{spacing}{1.7}
        \hspace{1.2in}
        \textbf {Отчет по Лабораторной работе} №23\\     % указать номер лабораторной
        ...
        \indent \hspace{1.2in} Работа выполнена: "1 мая 2022г" \\   % указать дату
